...
#
# 10/7/13: Based on the '2' version, tried using numpy arrays to speed up the algorithm, and perhaps save memory,
#      but did not help.  Move on to the '3' version.
...
for iSubset in xrange(0, len(S)):
    ...
    if curSubset.size > curSize:
        ...
        A_1 = A
        S_list_1 = S_list
        A = np.empty((nSubsets[curSize]+1, n+1), dtype=float)
